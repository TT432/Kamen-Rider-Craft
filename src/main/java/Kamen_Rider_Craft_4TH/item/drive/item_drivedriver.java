...
public class item_drivedriver extends RiderDriverItem {
	...
	public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
		if (entity instanceof EntityLivingBase) {
			...
			if (((EntityLivingBase) entity).getItemStackFromSlot(EntityEquipmentSlot.CHEST).getItem() == RiderItems.drivetroso) {

				if (player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() instanceof item_drivedriver) {
					return Refercence.MODID + ":textures/armor/" + get_lock(stack) + "_tire.png";
	...
	public static String get_lock(ItemStack itemstack) {
		...
		if (belt == RiderItems.drivedriver || item_drivedriver.get_core(itemstack) == 1 || item_drivedriver.get_core(itemstack) == 4 || item_drivedriver.get_core(itemstack) == 4) {
			return itemstack.hasTagCompound() ? tireName[itemstack.getTagCompound().getInteger("core2")] : "type_speed";

		} else if (belt == RiderItems.drivedriver_dark) {
			return itemstack.hasTagCompound() ? tireName[itemstack.getTagCompound().getInteger("core2")] : "type_next";
			...
			return itemstack.hasTagCompound() ? tireName[itemstack.getTagCompound().getInteger("core2")] : "dead_heat";
				...
				if (player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() instanceof RiderDriverItem) {
					...
					if (num == 1 || num == 2 || num == 5 || num == 7 || num == 3 || num == 6 || num == 8) {
						...
						if (player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() == RiderItems.drivedriver) {
							return Refercence.MODID + ":textures/armor/" + "drive" + CoreName[item_drivedriver.get_core(player.getItemStackFromSlot(EntityEquipmentSlot.FEET))] + ext;
						} else if (player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() == RiderItems.mach_driver_honoh) {
