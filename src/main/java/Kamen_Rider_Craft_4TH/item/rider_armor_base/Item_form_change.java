...
public class Item_form_change extends Item implements IHasModel
{
	...
	protected  Class<? extends RiderDriverItem> BELTCLASS;
	...
	public Item_form_change(String name, Class<? extends RiderDriverItem> beltClass, Item belt, String formName, String ridername, PotionEffect... effects)
	{
		super();
		this.setMaxDamage(0);
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
		if (!playerIn.inventory.armorInventory.get(1).isEmpty()) {
			if (playerIn.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem().getClass()==BELTCLASS) {
				...
				} else if(((RiderDriverItem) playerIn.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem()).Rider.equals(RIDER_NAME)){
					if(getNeedItem(playerIn))
						RiderDriverItem.set_Form_Item(playerIn.getItemStackFromSlot(EntityEquipmentSlot.FEET),this, 1);
